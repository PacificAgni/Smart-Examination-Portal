...
while($row=mysqli_fetch_array($result)){
    ...
    $result1 = mysqli_query($conn, $sql);
    $sql2="UPDATE `answerid` SET `Status`='CHECKED' where `answerid`.`testid`=$tid and `answerid`.`Marks` IS NOT NULL";
...
<body>
    <div class="heading"><h1 style="font-size:3rem;font-weight:bold">ANSWERSHEETS</h1></div>
    <div class="cont">
    <?php
    $sno=1;
    $sql="SELECT * FROM `answerid`";
    ...
    <td> <button type="radio" name="abc" value="<?php echo $row['testid']?>"><?php echo $row['Status']; ?></button></td>
    </tr>
